<?php $title = "Imag(in)ing Rochester - About"; include("header.php"); ?>

		<div class="infoPage" id="content">
			<h2>About this project</h2>
			<p>
				Imag(in)ing Rochester is a multimedia project that challenges people to interact with their
				environment in unique and unconventional ways. This project specifically addresses the
				city of Rochester and Rochester Institute of Technology as sites of complex structures of
				relationships between people, place, politics, and visual encounters.
			</p>
			<p>
